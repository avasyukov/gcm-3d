...
Point(3) = {0.495, -0.495, 0.495, meshPointDist};
Point(4) = {0.495, -0.495, -0.495, meshPointDist};
Point(5) = {-0.495, 0.495, -0.495, meshPointDist};
Point(6) = {-0.495, 0.495, 0.495, meshPointDist};
Point(7) = {0.495, 0.495, 0.495, meshPointDist};
Point(8) = {0.495, 0.495, -0.495, meshPointDist};
Line(9) = {1, 2};
Line(10) = {2, 3};
Line(11) = {3, 4};
Line(12) = {4, 1};
