...
//#define CONFIG_ENABLE_LOGGING 1
	...
	// FIXME
	// LOG_TRACE implementation should be done in the same way as for other logging routines
	#define LOG_TRACE(message) //std::cout << "TRACE: " << message << std::endl; //do { LOG4CXX_TRACE(logger, message) } while (0)
