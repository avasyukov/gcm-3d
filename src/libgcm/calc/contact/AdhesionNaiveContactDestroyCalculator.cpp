...
AdhesionNaiveContactDestroyCalculator::AdhesionNaiveContactDestroyCalculator()
{
	type = "AdhesionNaiveContactDestroyCalculator";

    scc = new SlidingNaiveContactCalculator();
    acc = new AdhesionNaiveContactCalculator();
};
...
void AdhesionNaiveContactDestroyCalculator::doCalc(CalcNode& cur_node, CalcNode& new_node, CalcNode& virt_node,
