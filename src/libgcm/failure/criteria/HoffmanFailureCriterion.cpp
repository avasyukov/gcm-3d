...
void gcm::HoffmanFailureCriterion::checkFailure(ICalcNode& node, const float tau) {
	...
	gcm::real X = (Xc + Xt)/2.0,
		...
		Zt = Yt,
		Zc = Yc,
		F12 = 1/Xt/Xt + 1/Yt/Yc - 1/Zt/Zc,
		F13 = 1/Xt/Xt - 1/Yt/Yc + 1/Zt/Zc,
		F23 = -1/Xt/Xt + 1/Yt/Yc + 1/Zt/Zc;	
	if ( (s11*s11/Xt/Xc + s22/Yt/Yc + s33/Zt/Zc + (s12*s12 + s23*s23 + s13*s13)/S/S - F12*s11*s22 - F23*s22*s33 
