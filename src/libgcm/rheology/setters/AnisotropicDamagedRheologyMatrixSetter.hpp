#ifndef ANISOTROPICDAMAGEDRHEOLOGYMATRIXSETTER_HPP
#define ANISOTROPICDAMAGEDRHEOLOGYMATRIXSETTER_HPP

#include "libgcm/rheology/setters/ISetter.hpp"

namespace gcm
{
        class AnisotropicDamagedRheologyMatrixSetter: public ISetter
        {
            public:
                /**
...
#endif /* ANISOTROPICDAMAGEDRHEOLOGYMATRIXSETTER_HPP */
