#ifndef ANISOTROPICRHEOLOGYMATRIXSETTER_HPP
#define ANISOTROPICRHEOLOGYMATRIXSETTER_HPP

#include "libgcm/rheology/setters/ISetter.hpp"

namespace gcm
{
        class AnisotropicRheologyMatrixSetter: public ISetter
        {
            public:
                /**
...
#endif /* ANISOTROPICRHEOLOGYMATRIXSETTER_HPP */
