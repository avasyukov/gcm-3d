...
gcm::VTKMarkeredMeshNGSnapshotWriter::VTKMarkeredMeshNGSnapshotWriter():VTKMarkeredMeshNGSnapshotWriter("snap_mesh_%m_cpu_%z_step_%n.vts")
{
}

gcm::VTKMarkeredMeshNGSnapshotWriter::VTKMarkeredMeshNGSnapshotWriter(const char* snapName) {
    INIT_LOGGER("gcm.snapshot.VTKMarkeredMeshNGSnapshotWriter");
    fname = string (snapName);
}

string gcm::VTKMarkeredMeshNGSnapshotWriter::getType() {
    return "VTKMarkeredMeshNGSnapshotWriter";
}

void gcm::VTKMarkeredMeshNGSnapshotWriter::dump(Mesh* mesh, int step)
{
    // TODO - check if the mesh is compatible
    dumpVTK(getFileName(MPI::COMM_WORLD.Get_rank(), step, mesh->getId()), *static_cast<const MarkeredMeshNG*>(mesh), step);
}

void gcm::VTKMarkeredMeshNGSnapshotWriter::dumpVTK(string filename, const MarkeredMeshNG& mesh, int step)
{
    ...
    auto& _mesh = const_cast<MarkeredMeshNG&>(mesh);
