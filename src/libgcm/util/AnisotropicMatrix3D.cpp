...
void gcm::AnisotropicMatrix3D::createAx(initializer_list<gcm_real> params)
{
	...
	gsl_matrix_set (a, 3, 0, -numbers.c11);
	gsl_matrix_set (a, 3, 1, -numbers.c16);
	gsl_matrix_set (a, 3, 2, -numbers.c15);
	
	gsl_matrix_set (a, 4, 0, -numbers.c16);
	gsl_matrix_set (a, 4, 1, -numbers.c66);
	gsl_matrix_set (a, 4, 2, -numbers.c56);
	
	gsl_matrix_set (a, 5, 0, -numbers.c15);
	gsl_matrix_set (a, 5, 1, -numbers.c56);
	gsl_matrix_set (a, 5, 2, -numbers.c55);
	
	gsl_matrix_set (a, 6, 0, -numbers.c12);
	gsl_matrix_set (a, 6, 1, -numbers.c26);
	gsl_matrix_set (a, 6, 2, -numbers.c25);
	
	gsl_matrix_set (a, 7, 0, -numbers.c14);
	gsl_matrix_set (a, 7, 1, -numbers.c46);
	gsl_matrix_set (a, 7, 2, -numbers.c45);

	gsl_matrix_set (a, 8, 0, -numbers.c13);
	gsl_matrix_set (a, 8, 1, -numbers.c36);
	gsl_matrix_set (a, 8, 2, -numbers.c35);
...
void gcm::AnisotropicMatrix3D::createAy(initializer_list<gcm_real> params)
{
	...
	gsl_matrix_set (a, 3, 0, -numbers.c16);
	gsl_matrix_set (a, 3, 1, -numbers.c12);
	gsl_matrix_set (a, 3, 2, -numbers.c14);
	
	gsl_matrix_set (a, 4, 0, -numbers.c66);
	gsl_matrix_set (a, 4, 1, -numbers.c26);
	gsl_matrix_set (a, 4, 2, -numbers.c46);
	
	gsl_matrix_set (a, 5, 0, -numbers.c56);
	gsl_matrix_set (a, 5, 1, -numbers.c25);
	gsl_matrix_set (a, 5, 2, -numbers.c45);
	
	gsl_matrix_set (a, 6, 0, -numbers.c26);
	gsl_matrix_set (a, 6, 1, -numbers.c22);
	gsl_matrix_set (a, 6, 2, -numbers.c24);
	
	gsl_matrix_set (a, 7, 0, -numbers.c46);
	gsl_matrix_set (a, 7, 1, -numbers.c24);
	gsl_matrix_set (a, 7, 2, -numbers.c44);
	
	gsl_matrix_set (a, 8, 0, -numbers.c36);
	gsl_matrix_set (a, 8, 1, -numbers.c23);
	gsl_matrix_set (a, 8, 2, -numbers.c34);
...
void gcm::AnisotropicMatrix3D::createAz(initializer_list<gcm_real> params)
{
	...
	gsl_matrix_set (a, 3, 0, -numbers.c15);
	gsl_matrix_set (a, 3, 1, -numbers.c14);
	gsl_matrix_set (a, 3, 2, -numbers.c13);
	
	gsl_matrix_set (a, 4, 0, -numbers.c56);
	gsl_matrix_set (a, 4, 1, -numbers.c46);
	gsl_matrix_set (a, 4, 2, -numbers.c36);
	
	gsl_matrix_set (a, 5, 0, -numbers.c55);
	gsl_matrix_set (a, 5, 1, -numbers.c45);
	gsl_matrix_set (a, 5, 2, -numbers.c35);
	
	gsl_matrix_set (a, 6, 0, -numbers.c25);
	gsl_matrix_set (a, 6, 1, -numbers.c24);
	gsl_matrix_set (a, 6, 2, -numbers.c23);
	
	gsl_matrix_set (a, 7, 0, -numbers.c45);
	gsl_matrix_set (a, 7, 1, -numbers.c44);
	gsl_matrix_set (a, 7, 2, -numbers.c34);
	
	gsl_matrix_set (a, 8, 0, -numbers.c35);
	gsl_matrix_set (a, 8, 1, -numbers.c34);
	gsl_matrix_set (a, 8, 2, -numbers.c33);
