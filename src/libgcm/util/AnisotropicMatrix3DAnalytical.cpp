...
//
//gcm::AnisotropicMatrix3DAnalytical::AnisotropicMatrix3DAnalytical(): ImmutableRheologyMatrixPtr()
//{
//
//}
//
...
//		double *eigenVec2, double l, float rho, const IAnisotropicElasticMaterial::RheologyProperties &C, int stage)
//{
//    // Analitycal search eigenvectors
//    // M * x = 0, x = (x1, x2, x3)
//    // then x[4-9] <= x[1-3]
