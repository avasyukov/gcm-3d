...
#define assert_eq(v1, v2) DO_ONCE( \
    if ((v1) != (v2)) \
...
#define assert_gt(v1, v2) DO_ONCE( \
    if ((v1) <= (v2)) \
...
#define assert_ge(v1, v2) DO_ONCE( \
    if ((v1) < (v2)) \
...
#define assert_lt(v1, v2) DO_ONCE( \
    if ((v1) >= (v2)) \
...
#define assert_le(v1, v2) DO_ONCE( \
    if ((v1) > (v2)) \
