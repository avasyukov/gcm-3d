...
void gcm::ElasticMatrix3D::self_check()
{
	gcm_matrix E;
	E.createE();
...
float gcm::ElasticMatrix3D::max_lambda()
{
	float res = 0;
...
void gcm::ElasticMatrix3D::zero_all()
{
	A.clear();
	L.clear();
	U.clear();
...
void gcm::ElasticMatrix3D::CreateAx(float la, float mu, float ro)
{
	zero_all();
...
void gcm::ElasticMatrix3D::CreateAy(float la, float mu, float ro)
{
	zero_all();
...
void gcm::ElasticMatrix3D::CreateAz(float la, float mu, float ro)
{
	zero_all();
...
void gcm::ElasticMatrix3D::CreateGeneralizedMatrix(float la, float mu, float ro, 
													float qjx, float qjy, float qjz)
{
...
void gcm::ElasticMatrix3D::createMatrixN(int i, int j, float *res)
{
