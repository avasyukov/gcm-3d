...
void gcm::ElasticMatrix3D::getRheologyParameters(initializer_list<gcm_real> params, gcm_real& lambda, gcm_real& mu, gcm_real& rho)
{
...
void gcm::ElasticMatrix3D::createAx(initializer_list<gcm_real> params)
{
	clear();

	gcm_real la, mu, rho;

	getRheologyParameters(params, la, mu, rho);
...
void gcm::ElasticMatrix3D::createAy(initializer_list<gcm_real> params)
{
	clear();
...
void gcm::ElasticMatrix3D::createAz(initializer_list<gcm_real> params)
{
	clear();
