...
TEST(Waves, IsotropicMaterialPWavePropagation)
{
...
TEST(Waves, MarkeredMeshIsotropicMaterialPWavePropagation)
{
    // Major test parameters
    ...
    runTaskAsTest("tasks/tests/markered-mesh-p-wave-test.xml", setPWaveAnalytics, STEPS, line, { "vz", "sxx", "syy", "szz" }, ALLOWED_VALUE_DEVIATION_PERCENT, ALLOWED_NUMBER_OF_BAD_NODES);
}
