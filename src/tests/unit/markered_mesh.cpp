...
TEST(MarkeredBoxMesh, getCellAABB) {
...
TEST(MarkeredBoxMesh, innerCells) {
...
TEST(MarkeredBoxMesh, cellNighbours) {
...
TEST(MarkeredBoxMesh, markersGeneration) {
...
TEST(MarkeredBoxMesh, innerFlagsReconstruction) {
...
TEST(MarkeredBoxMesh, reconstructBorder) {
...
TEST(MarkeredBoxMesh, markUnusedNodes) {
...
TEST(MarkeredBoxMesh, getCellsCommonPoints) {
...
TEST(MarkeredBoxMesh, findBorderNodeNormal) {
...
TEST(MarkeredBoxMesh, interpolation) {
	MarkeredBoxMeshGeneratorWrapper mg;
	MarkeredMesh m;
...
TEST(MarkeredBoxMesh, moveMarkers) {
	MarkeredBoxMeshGeneratorWrapper mg;
	MarkeredMesh m;
	mg.generate(&m, "4.0", "2.0", "4");
