...
DataBus::DataBus(Logger* new_logger)
{
	...
	MPI::Datatype req_types[] = {MPI::INT, MPI::INT, MPI::INT, MPI::INT};
	int req_lengths[] = {1, 1, 1, 1};
	...
	MPI_NODE_REQ = MPI::Datatype::Create_struct(4, req_lengths, req_displacements, req_types);
